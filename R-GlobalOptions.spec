...
Version  : 0.1.1
Release  : 25
URL      : https://cran.r-project.org/src/contrib/GlobalOptions_0.1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/GlobalOptions_0.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571838850
